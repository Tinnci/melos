...
const variantClass: Record<ButtonVariant, string> = {
  default: 'border-[#b43e16] bg-[#ff5a1f] text-black hover:bg-[#ff713d]',
  destructive: 'border-[#9a1717] bg-[#d52222] text-white hover:bg-[#ef3333]',
  outline:
  ...
  link: 'border-transparent bg-transparent text-[#c94412] underline-offset-4 hover:underline',
}
